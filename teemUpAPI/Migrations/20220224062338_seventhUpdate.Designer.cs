...
namespace teemUpAPI.Migrations
{
    ...
    [Migration("20220224062338_seventhUpdate")]
            ...
            modelBuilder.Entity("teemUpAPI.Models.teamMembers", b =>
                {
                    ...
                    b.Property<int?>("userPositionsId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("teemUpAPI.Models.teamMembers", b =>
                {
                    ...
                    b.HasOne("teemUpAPI.Models.userPositions", "userPositions")
                        .WithMany()
                        .HasForeignKey("userPositionsId");
